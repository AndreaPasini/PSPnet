...
class PSPNet(object):
    ...
    def __init__(self, nb_classes, resnet_layers, input_shape, weights):
        ...
        #ANDREA
        json_path = join("PSPNet-Keras-tensorflow-master/weights", "keras", weights + ".json")
        h5_path = join("PSPNet-Keras-tensorflow-master/weights", "keras", weights + ".h5")
    ...
    def set_npy_weights(self, weights_path):
        ...
        #ANDREA
        npy_weights_path = join("PSPNet-Keras-tensorflow-master/weights", "npy", weights_path + ".npy")
        json_path = join("PSPNet-Keras-tensorflow-master/weights", "keras", weights_path + ".json")
        h5_path = join("PSPNet-Keras-tensorflow-master/weights", "keras", weights_path + ".h5")
